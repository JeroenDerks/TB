...
void loop() {
  ...
  if (val2 != pirState2) {
    if (val2 == HIGH) {
      ...
      getRGB(hue3, 255, 255, rgb_colors3);
      for (int i = 0; i <= NUMPIX_2 - 51; i++) {
        ...
        strip2.show();
        // LEDstrip 2.2
        strip3.setPixelColor(NUMPIX_3 - i, strip3.Color(rgb_colors3[0], rgb_colors3[1], rgb_colors3[2]));
        strip3.show();
        delay(4);
      }
    }
  ...
  if (!changeColor2 && sin1 > 0.0 && sin1 < 0.2) changeColor2 = true;
    ...
    sat2 -= 40;
    getRGB(hue2, sat2, 255, rgb_colors2);
    changeColor2 = false;
  }
  else if (changeColor2 && sin1 > 0.95) {
    sat2 += 40;
  ...
  if (!changeColor3 && sin1 > 0.0 && sin1 < 0.2) changeColor3 = true;
  else if (changeColor3 && sin1 < -0.95) {
    hue3 -= 30;
    hue3 = hue2 % 360;
    getRGB(hue2, 255, 255, rgb_colors3);
    changeColor2 = false;
  }
  else if (changeColor3 && sin1 > 0.95) {
    hue3 += 30;
  ...
  for (int i = 0; i < 11; i++) {
    ...
    cPlus *= cPlus * 0.01;
    if (cPlus > 1.0) cPlus = 1.0;
    strip3.setPixelColor(pix1 - 1  - i, strip3.Color (rgb_colors3[0] * cMinus, rgb_colors3[1] * cMinus, rgb_colors3[2] * cMinus));
    strip3.setPixelColor(pix1, strip3.Color (0, 0, 0));
    strip3.setPixelColor(pix1 + 1 + i, strip3.Color(rgb_colors3[0] * cPlus, rgb_colors3[1] * cPlus, rgb_colors3[2] * cPlus));
  }
  strip3.show();
}
