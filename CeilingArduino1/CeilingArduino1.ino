...
void loop() {
  ...
  ///////////////// LEDstrip 1.1 = NUMPIX_1 /////////////////

  float sin1 = sin(millis() / 2700.0);
  ...
  if (val2 != pirState2) {
    if (val2 == HIGH) {
      ...
      for (int i = 0; i <= NUMPIX_2 - 51; i++) {
        // LEDstrip 2.1
        strip2.setPixelColor(51 - i, strip2.Color(rgb_colors2[0], rgb_colors2[1], rgb_colors2[2]));
        strip2.setPixelColor(51 + i, strip2.Color(rgb_colors2[0], rgb_colors2[1], rgb_colors2[2]));
        strip2.show();
        // LEDstrip 2.2
        strip3.setPixelColor(NUMPIX_3 - i, strip3.Color(rgb_colors2[0], rgb_colors2[1], rgb_colors2[2]));
        strip3.show();
        delay(4);
      }
    }
  ...
  ///////////////// LEDstrip 2.1 = NUMPIX_2 /////////////////

  sin1 = sin(millis() / 3700.0);
  absSin1 = 1.0 + sin1;
  ...
  for (int i = 0; i < 11; i++) {
    ...
    cPlus *= cPlus * 0.01;
    if (cPlus > 1.0) cPlus = 1.0;
    strip2.setPixelColor(pix1 - 1  - i, strip1.Color (rgb_colors2[0] * cMinus, rgb_colors2[1] * cMinus, rgb_colors2[2] * cMinus));
    strip2.setPixelColor(pix1, strip1.Color (0, 0, 0));
    strip2.setPixelColor(pix1 + 1 + i, strip1.Color(rgb_colors2[0] * cPlus, rgb_colors2[1] * cPlus, rgb_colors2[2] * cPlus));
  }
  strip2.show();

  ///////////////// LEDstrip 2.2 = NUMPIX_3 /////////////////

  sin1 = sin(millis() / 2900.0);
  absSin1 = 1.0 + sin1;
  ...
  for (int i = 0; i < 11; i++) {
    ...
    cPlus *= cPlus * 0.01;
    if (cPlus > 1.0) cPlus = 1.0;
    strip3.setPixelColor(pix1 - 1  - i, strip1.Color (rgb_colors2[0] * cMinus, rgb_colors2[1] * cMinus, rgb_colors2[2] * cMinus));
    strip3.setPixelColor(pix1, strip1.Color (0, 0, 0));
    strip3.setPixelColor(pix1 + 1 + i, strip1.Color(rgb_colors2[0] * cPlus, rgb_colors2[1] * cPlus, rgb_colors2[2] * cPlus));
  }
  strip3.show();
}
